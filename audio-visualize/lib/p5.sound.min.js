...
!(function (n) {
        ...
        return (
          ...
          (l.prototype.get = function (t) {
            ...
            for (var e = {}, n = 0; n < t.length; n++) {
              ...
              this.isObject(t[i])
                ...
                : c instanceof l
                ? (o[i] = c.get())
                : this.isFunction(c) || this.isUndef(c) || (o[i] = c);
            }
            return e;
          }),
          ...
          (l.prototype._readOnly = function (t) {
            if (Array.isArray(t))
              ...
              Object.defineProperty(this, t, { writable: !1, enumerable: !0 });
          }),
          ...
          Object.defineProperty(l, "context", {
            ...
            set: function (t) {
              (e = l.Context && t instanceof l.Context ? t : new l.Context(t)),
          ...
          return (
            (e.Multiply = function (t) {
              this.createInsOuts(2, 0),
                (this._mult = this.input[0] = this.output = new e.Gain()),
      ...
      void 0 ===
        (r = function (e) {
          ...
          return (
            ...
            (e.Signal.prototype.connect = e.SignalBase.prototype.connect),
      ...
      void 0 ===
        (r = function (u) {
          ...
          return (
            ...
            (u.TimelineSignal.prototype.linearRampToValueAtTime = function (
              t,
              e
            ) {
              return (
            ...
            (u.TimelineSignal.prototype.setValueCurveAtTime = function (
              t,
              e,
              n,
              i
              ...
              for (var r = new Array(t.length), o = 0; o < r.length; o++)
              ...
              if (n && n.time === t)
                ...
                i &&
                  ...
                  i.type === u.TimelineSignal.Type.Linear
                    ? this.linearRampToValueAtTime(e, t)
                    : i.type === u.TimelineSignal.Type.Exponential &&
                      this.exponentialRampToValueAtTime(e, t)),
                  this.setValueAtTime(e, t);
              }
              return this;
            }),
            (u.TimelineSignal.prototype.linearRampToValueBetween = function (
              t,
              e,
              n
            ) {
              return (
                this.setRampPoint(e), this.linearRampToValueAtTime(t, n), this
              );
            }),
            ...
            (u.TimelineSignal.prototype.getValueAtTime = function (t) {
              ...
              if (null === n) i = this._initial;
                ...
                i =
                  n.type === u.TimelineSignal.Type.Curve
                    ? this._curveInterpolate(n.time, n.value, n.duration, t)
                    : null === e
                    ? n.value
                    : e.type === u.TimelineSignal.Type.Linear
                    ...
                    : e.type === u.TimelineSignal.Type.Exponential
            ...
            (u.TimelineSignal.prototype._exponentialApproach = function (
              t,
              e,
              n,
              i,
            ...
            (u.TimelineSignal.prototype._linearInterpolate = function (
              t,
              e,
              n,
              i,
            ...
            (u.TimelineSignal.prototype._exponentialInterpolate = function (
              t,
              e,
              n,
              i,
            ...
            (u.TimelineSignal.prototype._curveInterpolate = function (
              t,
              e,
              n,
              i
              ...
              return a === s
                ? u
                : this._linearInterpolate(s, u, a, c, o * (r - 1));
            }),
          ...
          return (
            (r.Clock = function () {
              ...
              (this.callback = t.callback),
                ...
                (this.ticks = 0),
                (this._state = new r.TimelineState(r.State.Stopped)),
            ...
            (r.Clock.prototype.start = function (t, e) {
              return (
                (t = this.toSeconds(t)),
                this._state.getValueAtTime(t) !== r.State.Started &&
                  this._state.add({
            ...
            (r.Clock.prototype.pause = function (t) {
              return (
                (t = this.toSeconds(t)),
                this._state.getValueAtTime(t) === r.State.Started &&
                  this._state.setStateAtTime(r.State.Paused, t),
                this
              );
            }),
        ...
        (r = function (i) {
          function t(t, e, n) {
            if (t.input)
              Array.isArray(t.input)
                ? (i.prototype.isUndef(n) && (n = 0), this.connect(t.input[n]))
          ...
          return (
            ...
            Object.defineProperty(i.Context.prototype, "updateInterval", {
              ...
              set: function (t) {
                (this._updateInterval = Math.max(t, i.prototype.blockTime)),
            ...
            i.supported &&
              ...
              AudioNode.prototype.connect !== t &&
                ((AudioNode.prototype.connect = t),
                (AudioNode.prototype.disconnect = function (t, e, n) {
        ...
        (r = function (e) {
          ...
          return (
            (e.Subtract = function (t) {
              this.createInsOuts(2, 0),
                (this._sum = this.input[0] = this.output = new e.Gain()),
        ...
        (r = function (s) {
          ...
          return (
              ...
              for (var n = t.split(/\W+/), i = 0; i < n.length; i++)
                if (((t = n[i]), this._events.hasOwnProperty(t)))
                  if (s.prototype.isUndef(e)) this._events[t] = [];
                    ...
                    for (var r = this._events[t], o = 0; o < r.length; o++)
                      r[o] === e && r.splice(o, 1);
              return this;
            }),
            (s.Emitter.prototype.emit = function (t) {
              if (this._events) {
                ...
                if (this._events.hasOwnProperty(t))
                  for (var n = this._events[t], i = 0, r = n.length; i < r; i++)
                    n[i].apply(this, e);
              }
              return this;
            }),
            ...
            (s.Emitter.prototype.dispose = function () {
              return (
                s.prototype.dispose.call(this), (this._events = null), this
              );
            }),
            s.Emitter
          );
          ...
          return (
            ...
            (i.SignalBase.prototype.connect = function (t, e, n) {
              return (
                ...
                (i.TimelineSignal && i.TimelineSignal === t.constructor)
                  ? (t._param.cancelScheduledValues(0),
                    (t._param.value = 0),
                    (t.overridden = !0))
                  : t instanceof AudioParam &&
                    (t.cancelScheduledValues(0), (t.value = 0)),
        ...
        (r = function (n) {
          return (
            ...
            (n.Time.prototype._toNotationHelper = function (t, e) {
              for (
                var n = this._notationToUnits(e[e.length - 1]), i = "", r = 0;
                r < e.length;
                r++
              ) {
                var o = this._notationToUnits(e[r]),
                  s = t / o;
                if (
                  (1 - (s % 1) < 1e-6 && (s += 1e-6), 0 < (s = Math.floor(s)))
                ) {
                  if (
                    ((i += 1 === s ? e[r] : s.toString() + "*" + e[r]),
                    (t -= s * o) < n)
                  )
                    break;
                  i += " + ";
            ...
            (n.Time.prototype._notationToUnits = function (t) {
              for (
                var e = this._primaryExpressions, n = [e.n, e.t, e.m], i = 0;
                i < n.length;
                i++
              ) {
                var r = n[i],
            ...
            (n.Time.prototype.toBarsBeatsSixteenths = function () {
              ...
              return (
                ...
                3 < (i = i.toString()).length && (i = parseFloat(i).toFixed(3)),
                [n, e, i].join(":")
              );
            }),
        ...
        (r = function (i) {
          return (
            (i.TimeBase = function (t, e) {
              ...
              if (((this._expr = this._noOp), t instanceof i.TimeBase))
                this.copy(t);
                ...
                this.isString(t)
                  ? this.set(t)
                  : this.isUndef(t) && (this._expr = this._defaultExpr());
            }),
            i.extend(i.TimeBase),
            ...
            (i.TimeBase.prototype._parseBinary = function (t, e) {
              var n;
              this.isUndef(e) && (e = 2),
                (n = e < 0 ? this._parseUnary(t) : this._parseBinary(t, e - 1));
              for (
                var i = t.peek();
                i && this._matchGroup(i, this._binaryExpressions, e);
            ...
            (i.TimeBase.prototype._parsePrimary = function (t) {
              ...
              throw new SyntaxError(
                "Tone.TimeBase: Cannot process token " + e.value
              );
            }),
            ...
            (i.TimeBase.prototype._pushExpr = function (t, e, n) {
              return (
                t instanceof i.TimeBase || (t = new this.constructor(t, n)),
                (this._expr = this._binaryExpressions[e].method.bind(
                  this,
                  this._expr,
                  t._expr
                )),
          ...
          return (
            ...
            (i.Param.prototype.setTargetAtTime = function (t, e, n) {
              return (
                ...
                (t = Math.max(this._minOutput, t)),
                (n = Math.max(this._minOutput, n)),
                this._param.setTargetAtTime(t, this.toSeconds(e), n),
                this
              );
            }),
          ...
          return (
              ...
              if (1 < this._timeline.length) {
                ...
                if (0 <= e)
                  if (this._timeline[e].time === t) {
                    for (var n = e; 0 <= n && this._timeline[n].time === t; n--)
                      e = n;
            ...
            (e.Timeline.prototype._search = function (t) {
              ...
              for (; e < i; ) {
                ...
                if (o.time === t) {
                  for (var a = r; a < this._timeline.length; a++)
            ...
            (e.Timeline.prototype._iterate = function (t, e, n) {
              (this._iterating = !0),
                (e = this.defaultArg(e, 0)),
                (n = this.defaultArg(n, this._timeline.length - 1));
                ...
                return (
                  (function t(e, n, i) {
                    if (Array.isArray(e) || (NodeList && e instanceof NodeList))
                      ...
                      t(document.querySelectorAll(e), n, i);
        ...
        ((self.AudioWorkletNode = function (t, e, n) {
          var i = h(t)[e],
            r = t.createScriptProcessor(
              void 0,
              2,
              n && n.outputChannelCount ? n.outputChannelCount[0] : 2
            );
      ...
      void 0 ===
        (r = function (r) {
          (r.Frequency = function (t, e) {
            ...
            (r.Frequency.prototype._primaryExpressions = Object.create(
              ...
              return (
                (this._expr = function (t, e) {
                  for (var n = t(), i = [], r = 0; r < e.length; r++)
                    i[r] = n * this.intervalToFrequencyRatio(e[r]);
                  return i;
                }.bind(this, this._expr, t)),
                this
              );
      ...
      void 0 ===
        (r = function (i) {
          return (
            ...
            (i.TransportTime.prototype._unaryExpressions = Object.create(
              i.Time.prototype._unaryExpressions
            )),
      ...
      void 0 ===
        (r = function (u) {
          ...
          function n(t, e, n) {
            var i = new t();
            return (
              n._eval(e[0]).connect(i, 0, 0), n._eval(e[1]).connect(i, 0, 1), i
            );
          }
          function i(t, e, n) {
            var i = new t();
          ...
          return (
            ...
            (u.Expr._Expressions = {
              ...
              func: {
                abs: { regexp: /^abs/, method: i.bind(this, u.Abs) },
                mod: {
                  regexp: /^mod/,
                  method: function (t, e) {
                    var n = o(t[1]),
              ...
              unary: {
                "-": { regexp: /^\-/, method: i.bind(this, u.Negate) },
                "!": { regexp: /^\!/, method: i.bind(this, u.NOT) },
              },
            }),
                ...
                for (var e in u.Expr._Expressions) {
                  ...
                  for (var i in n) {
                    var r = n[i],
                      ...
                      s = t.match(o);
                    if (null !== s)
                      return { type: e, value: s[0], method: r.method };
                  }
                }
          ...
          return (
            (e.Modulo = function (t) {
              this.createInsOuts(1, 0),
                (this._shaper = new e.WaveShaper(Math.pow(2, 16))),
                (this._multiply = new e.Multiply()),
                (this._subtract = this.output = new e.Subtract()),
            ...
            (e.Pow = function (t) {
              (this._exp = this.defaultArg(t, 1)),
                (this._expScaler =
                  this.input =
                  this.output =
                    new e.WaveShaper(this._expFunc(this._exp), 8192));
            }),
      ...
      void 0 ===
        (r = function (e) {
          ...
          return (
            ...
            (e.TimelineState.prototype.getValueAtTime = function (t) {
              var e = this.get(t);
  ...
  function (t, e, n) {
    ...
    (p5.prototype.getMasterVolume = function () {
      ...
      (p5.prototype.masterVolume = function (t) {
        var e =
    ...
    function u(t, e) {
      for (
        var n = t.length + e.length, i = new Float32Array(n), r = 0, o = 0;
        o < n;
    ...
    p5.prototype.registerMethod("init", function () {
      ...
      Promise.all(
        v.map(function (t) {
          var e = new Blob([t], { type: "application/javascript" }),
    ...
    var w,
      x = p.audiocontext;
    void 0 !== x.createStereoPanner
      ? (w = (function () {
          function n(t, e) {
            g(this, n),
              (this.stereoPanner = this.input = x.createStereoPanner()),
      ...
      : (w = (function () {
          function i(t, e, n) {
            g(this, i),
              (this.input = x.createGain()),
              t.connect(this.input),
              (this.left = x.createGain()),
              (this.right = x.createGain()),
              (this.left.channelInterpretation = "discrete"),
              (this.right.channelInterpretation = "discrete"),
              1 < n
                ? ((this.splitter = x.createChannelSplitter(2)),
                  this.input.connect(this.splitter),
                  this.splitter.connect(this.left, 1),
                  this.splitter.connect(this.right, 0))
                : (this.input.connect(this.left),
                  this.input.connect(this.right)),
              (this.output = x.createChannelMerger(2)),
            ...
            T(i, [
              {
                ...
                value: function (t, e) {
                  ...
                  this.left.gain.linearRampToValueAtTime(s, i),
                    this.right.gain.linearRampToValueAtTime(o, i);
                },
              },
              {
                key: "inputChannels",
    ...
    var N = (function () {
      function o(t, e, n, i) {
        ...
        (this._onended = function () {}),
          ...
          (this.panPosition = 0),
          (this.panner = new S(this.output, p.input, 2)),
          (this.url || this.file) && this.load(e, n),
          p.soundArray.push(this),
          (this._whileLoading = "function" == typeof i ? i : function () {}),
        ...
        (function (t, e, n) {
        ...
        })(o, [
          {
            ...
            value: function (n, i) {
              ...
              if (void 0 !== this.url && "" !== this.url) {
                    ...
                    if (200 === s.status) {
                      ...
                      O.decodeAudioData(
                        ...
                        function (t) {
                          r.panner &&
                            ((r.buffer = t),
                            r.panner.inputChannels(t.numberOfChannels),
                            n && n(r));
                        },
                        function () {
                          if (r.panner) {
                ...
                (t.onload = function () {
                  r.panner &&
                    O.decodeAudioData(t.result, function (t) {
                      r.panner &&
                        ((r.buffer = t),
                        r.panner.inputChannels(t.numberOfChannels),
                        n && n(r));
              ...
              if (this.output) {
                ...
                if (
                  ...
                  "restart" === this.mode &&
                    ...
                    (this.bufferSourceNode.stop(a), this._counterNode.stop(a)),
                  ...
                  if (
                    ...
                    if (!(0 <= i && i < this.buffer.duration))
                      throw "start time out of range";
                    o = i;
                  } else o = 0;
                  (r =
                    r &&
                    (r <= this.buffer.duration - o ? r : this.buffer.duration)),
                    this._paused
                      ? (this.bufferSourceNode.start(a, this.pauseTime, r),
                        this._counterNode.start(a, this.pauseTime, r))
                      : (this.bufferSourceNode.start(a, o, r),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                var n = p.audiocontext.currentTime;
                this.bufferSourceNode.playbackRate.cancelScheduledValues(n),
                  this.bufferSourceNode.playbackRate.linearRampToValueAtTime(
                    Math.abs(t),
                    n
                  ),
                  this._counterNode.playbackRate.cancelScheduledValues(n),
            ...
            value: function (t, e, n) {
              if ("number" == typeof t) {
                ...
                this.output.gain.cancelScheduledValues(o + r),
                  this.output.gain.linearRampToValueAtTime(s, o + r),
          ...
          },
          {
            ...
            value: function () {
              return this.reversed
                ? Math.abs(this._lastPos - this.buffer.length) / O.sampleRate
                : this._lastPos / O.sampleRate;
            },
          },
          {
            key: "jump",
            value: function (t, e) {
              ...
              this.isPlaying() &&
                (this.stop(0),
                this.play(0, this.playbackRate, this.output.gain.value, n, i));
            },
          },
          {
            key: "channels",
          ...
          },
          {
            ...
            value: function () {
              ...
              var t = this._lastPos / O.sampleRate,
                e = this.getVolume();
              this.setVolume(0, 0.001);
              for (var n = this.buffer.numberOfChannels, i = 0; i < n; i++)
                this.buffer.getChannelData(i).reverse();
              (this.reversed = !this.reversed),
                this.isPlaying() && t && this.jump(this.duration() - t),
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.length,
                n = t[0].length,
                i = O.createBuffer(e, n, O.sampleRate);
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                n._workletNode &&
                  (n._workletNode.disconnect(), delete n._workletNode),
                ...
                (i.buffer = (function (t) {
                  for (
                    var e = t.length,
                      n = O.createBuffer(1, t.length, O.sampleRate),
                ...
                i.playbackRate.setValueAtTime(n.playbackRate, t),
          ...
          {
            key: "processPeaks",
            value: function (o, t, e, n) {
              var i = this.buffer.length,
                r = this.buffer.sampleRate,
                s = this.buffer,
                a = [],
                u = t || 0.9,
                c = e || 0.22,
                l = n || 200,
                h = new window.OfflineAudioContext(1, i, r),
                p = h.createBufferSource();
              p.buffer = s;
              ...
              (f.type = "lowpass"),
                ...
                (h.oncomplete = function (t) {
                  if (self.panner) {
                    for (
                      var e = t.renderedBuffer, n = e.getChannelData(0);
                      (a = R(n, u)),
                        (u -= 0.005),
                        Object.keys(a).length < l && c <= u;
                    ...
                    var i = (function (t, i) {
                        ...
                        t.forEach(function (e) {
                          try {
                            ...
                            if (
                              ...
                              if (isNaN(n)) return;
                              r.push({ tempo: Math.round(n), count: e.count });
                            }
                          } catch (t) {
                            throw t;
                          }
                      ...
                      (function (t) {
                        for (
                          var e = [], n = Object.keys(t).sort(), i = 0;
                          i < n.length;
                          i++
                        )
                          for (var r = 0; r < 10; r++) {
                            ...
                            if (o && s) {
                              var a = o.sampleIndex,
                                u = s.sampleIndex - a;
                              0 < u && o.intervals.push(u),
                                e.some(function (t) {
                                  if (t.interval === u) return t.count++, t;
                                }) || e.push({ interval: u, count: 1 });
                            }
                          }
                        return e;
                      })(a),
                    ...
                    var r = (function (t, e, n, i) {
                      for (
                        var r = [], o = Object.keys(t).sort(), s = 0;
                        s < o.length;
                        s++
                      )
                        for (
                          var a = t[o[s]], u = 0;
                          u < a.intervals.length;
                          u++
                        ) {
                          var c = Math.round(
                            Math.abs(60 / (a.intervals[u] / n))
                          );
                          (c = q(c)),
                            Math.abs(c - e) < i && r.push(a.sampleIndex / n);
                        }
                      return (r = r.filter(function (t, e, n) {
                        if (0.01 < n[e + 1] - t) return !0;
                      }));
      ...
      return (
        (function (t, e, n) {
        ...
        })(e, [
          {
            ...
            value: function (t, e) {
              p.meter.disconnect(),
                e && (this._workletNode.parameters.get("smoothing").value = e),
                null == t
                  ? p.meter.connect(this._workletNode)
                  : t
            ...
            value: function (t) {
              t
                ? t.hasOwnProperty("input")
                  ...
                  : this.output.connect(t)
                : this.output.connect(this.panner.connect(p.input));
            },
          },
          {
            key: "disconnect",
          ...
          },
          {
            key: "toggleNormalize",
            value: function (t) {
              (this.normalize = "boolean" == typeof t ? t : !this.normalize),
    ...
    var F = (function () {
        function n(t, e) {
          !(function (t, e) {
            ...
            (this.input = this.analyser = p.audiocontext.createAnalyser()),
          ...
          (function (t, e, n) {
              ...
              value: function () {
                for (
                  ...
                  "number" == typeof arguments[i] &&
                    ((t = arguments[i]), (this.analyser.fftSize = 2 * t)),
                    "string" == typeof arguments[i] && (e = arguments[i]);
                if (e && !p5.prototype._isSafari())
                  return (
                    (function (t) {
                      t.timeDomain instanceof Float32Array == !1 &&
                        (t.timeDomain = new Float32Array(
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                if (
                  ("bass" === t
                    ? ((t = this.bass[0]), (e = this.bass[1]))
                    : "lowMid" === t
                    ? ((t = this.lowMid[0]), (e = this.lowMid[1]))
                    : "mid" === t
                    ? ((t = this.mid[0]), (e = this.mid[1]))
                    : "highMid" === t
                    ? ((t = this.highMid[0]), (e = this.highMid[1]))
                    : "treble" === t &&
                      ((t = this.treble[0]), (e = this.treble[1])),
                  "number" != typeof t)
                )
                  ...
                  if (t && e) {
                    ...
                    for (
                      var r = Math.round((t / n) * this.freqDomain.length),
                        o = Math.round((e / n) * this.freqDomain.length),
                        s = 0,
                        a = 0,
                        u = r;
                      u <= o;
            ...
            },
            {
              ...
              value: function () {
                for (
                  var t = p.audiocontext.sampleRate / 2, e = 0, n = 0, i = 0;
                  i < this.freqDomain.length;
                  i++
                )
                  (e += i * this.freqDomain[i]), (n += this.freqDomain[i]);
                var r = 0;
            ...
            },
            {
              ...
              value: function () {
                ...
                p.soundArray.splice(t, 1),
                  this.analyser &&
                    (this.analyser.disconnect(), delete this.analyser);
              },
            },
            {
              key: "linAverages",
            ...
            },
            {
              ...
              value: function (t) {
                for (
                  ...
                  Math.round((s * e) / this.freqDomain.length) > t[o].hi && o++,
                    (r[o] = void 0 !== r[o] ? (r[o] + n[s]) / 2 : n[s]);
                }
                return r;
              },
            },
    ...
    var K = (function () {
        function r(t, e) {
          ...
          (this.started = !1),
            ...
            this.output.gain.setValueAtTime(0.5, p.audiocontext.currentTime),
            this.oscillator.connect(this.output),
            (this.panPosition = 0),
            (this.connection = p.input),
            (this.panner = new S(this.output, this.connection, 1)),
          ...
          (function (t, e, n) {
          ...
          })(r, [
            {
              ...
              value: function (t, e) {
                ...
                if (!this.started) {
                  ...
                  (this.oscillator = p.audiocontext.createOscillator()),
                  (this.oscillator.frequency.value = Math.abs(i)),
                  (this.oscillator.type = r),
                  this.oscillator.connect(this.output),
                  (t = t || 0),
                  this.oscillator.start(t + p.audiocontext.currentTime),
                  (this.freqNode = this.oscillator.frequency),
                  this._freqMods))
                    void 0 !== this._freqMods[o].connect &&
                      this._freqMods[o].connect(this.oscillator.frequency);
                  this.started = !0;
                }
              },
            },
            ...
            },
            {
              ...
              value: function (t, e, n) {
                ...
                if ("number" != typeof t || isNaN(t)) {
                  ...
                  var o = p.audiocontext.currentTime;
                  0 === i
                    ? this.oscillator.frequency.setValueAtTime(t, r + o)
                    : 0 < t
            ...
            },
            {
              ...
              value: function (t) {
                ...
                (this.phaseAmount = t),
                  this.dNode ||
                    ((this.dNode = p.audiocontext.createDelay()),
            ...
            },
            {
              ...
              value: function (t) {
                var e = new I.a(t);
                return J(this, e, this.mathOps.length - 1, this.output, I.a);
              },
            },
            {
              key: "mult",
              value: function (t) {
                var e = new G.a(t);
                return J(this, e, this.mathOps.length - 1, this.output, G.a);
              },
            },
            {
              key: "scale",
              value: function (t, e, n, i) {
                ...
                o =
                  4 === arguments.length
                    ? ((r = p5.prototype.map(n, t, e, 0, 1) - 0.5),
                      p5.prototype.map(i, t, e, 0, 1) - 0.5)
                    : ((r = t), e);
                var s = new z.a(r, o);
                return J(this, s, this.mathOps.length - 1, this.output, z.a);
              },
            },
          ]),
          r
      ...
      tt = (function () {
        function e(t) {
          return $(this, e), Z(this, X(e).call(this, t, "sine"));
        }
        return Y(e, K), e;
      })(),
      et = (function () {
        function e(t) {
          return $(this, e), Z(this, X(e).call(this, t, "triangle"));
        }
        return Y(e, K), e;
      })(),
      nt = (function () {
        function e(t) {
          return $(this, e), Z(this, X(e).call(this, t, "sawtooth"));
        }
        return Y(e, K), e;
      })(),
      it = (function () {
        function e(t) {
          return $(this, e), Z(this, X(e).call(this, t, "square"));
        }
        return Y(e, K), e;
      })(),
      rt = K,
    ...
    (p5.Envelope = function (t, e, n, i, r, o) {
      ...
      (p5.Envelope.prototype.setADSR = function (t, e, n, i) {
        (this.aTime = t),
          ...
          (this.sPercent = n || 0),
          (this.dLevel =
            void 0 !== n ? n * (this.aLevel - this.rLevel) + this.rLevel : 0),
          (this.rTime = i || 0),
          this._setRampAD(t, e);
      }),
      ...
      (p5.Envelope.prototype._setRampAD = function (t, e) {
        ...
        var n = 1;
        (n = Math.log(1 / this.checkExpInput(1 - this._rampHighPercentage))),
      ...
      (p5.Envelope.prototype.setRampPercentages = function (t, e) {
        ...
        var n = 1;
        (n = Math.log(1 / this.checkExpInput(1 - this._rampHighPercentage))),
          (this._rampAttackTC = this._rampAttackTime / this.checkExpInput(n)),
          (n = Math.log(1 / this._rampLowPercentage)),
          (this._rampDecayTC = this._rampDecayTime / this.checkExpInput(n));
      }),
      ...
      (p5.Envelope.prototype.triggerAttack = function (t, e) {
        ...
        !0 === this.isExponential
          ? this.control.exponentialRampToValueAtTime(this.checkExpInput(i), n)
          ...
          !0 === this.isExponential
            ? (this.control.exponentialRampToValueAtTime(
              ...
              (i = this.checkExpInput(this.control.getValueAtTime(n))),
          ...
          !0 === this.isExponential
            ...
            !0 === this.isExponential
              ? (this.control.exponentialRampToValueAtTime(
                ...
                this.control.cancelScheduledValues(n),
                this.control.exponentialRampToValueAtTime(i, n))
              : (this.control.linearRampToValueAtTime(this.rLevel, n),
                (i = this.control.getValueAtTime(n)),
                this.control.cancelScheduledValues(n),
                this.control.linearRampToValueAtTime(i, n)),
            (this.wasTriggered = !1);
      ...
      (p5.Envelope.prototype.ramp = function (t, e, n, i) {
        ...
        a < o
          ...
          void 0 !== s &&
            (o < s
              ? this.control.setTargetAtTime(s, r, this._rampAttackTC)
              : s < o && this.control.setTargetAtTime(s, r, this._rampDecayTC));
      }),
      ...
      (p5.Envelope.prototype.mult = function (t) {
        var e = new G.a(t),
          n = this.mathOps.length,
          i = this.output;
        return p5.prototype._mathChain(this, e, n, i, G.a);
      }),
      (p5.Envelope.prototype.scale = function (t, e, n, i) {
        var r = new z.a(t, e, n, i),
          o = this.mathOps.length,
          s = this.output;
        return p5.prototype._mathChain(this, r, o, s, z.a);
      }),
    ...
    var ft = (function () {
        for (
          var t = 2 * p.audiocontext.sampleRate,
            e = p.audiocontext.createBuffer(1, t, p.audiocontext.sampleRate),
            n = e.getChannelData(0),
            i = 0;
          i < t;
          i++
      ...
      mt = (function () {
        function i(t) {
          ...
          return (
            ...
            delete (e = lt(this, ht(i).call(this))).f,
            delete e.freq,
            delete e.oscillator,
            (n = "brown" === t ? yt : "pink" === t ? dt : ft),
            (e.buffer = n),
            e
          );
        }
            ...
            },
            {
              ...
              value: function () {
                this.started && this.stop(),
                  (this.noise = p.audiocontext.createBufferSource()),
    ...
    var kt = (function () {
      function r(t, e) {
        ...
        !(function (t, e) {
          ...
          ((n = Tt(this, wt(r).call(this, t, "sawtooth"))).w = e || 0),
          (n.osc2 = new nt(t)),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (!this.started) {
                ...
                (this.oscillator = p.audiocontext.createOscillator()),
                  this.oscillator.frequency.setValueAtTime(r, n),
                  (this.oscillator.type = o),
                  this.oscillator.connect(this.output),
                  this.oscillator.start(i + n),
                  (this.osc2.oscillator = p.audiocontext.createOscillator()),
                  this.osc2.oscillator.frequency.setValueAtTime(r, i + n),
            ...
            value: function (t, e, n) {
              ...
              if ("number" == typeof t) {
                ...
                this.oscillator.frequency.cancelScheduledValues(o),
                  this.oscillator.frequency.setValueAtTime(s, o + r),
                  this.oscillator.frequency.exponentialRampToValueAtTime(
                    t,
                    r + i + o
                  ),
                  this.osc2.oscillator.frequency.cancelScheduledValues(o),
                  this.osc2.oscillator.frequency.setValueAtTime(s, o + r),
        ...
        return (
          (function (t, e, n) {
                  ...
                  window.navigator.mediaDevices
                    ...
                    .then(function (t) {
                      (i.stream = t),
                        (i.enabled = !0),
                        (i.mediaStream =
                          p.audiocontext.createMediaStreamSource(t)),
            ...
            },
            {
              ...
              value: function (t) {
                return (
                  t && (this.amplitude.smoothing = t), this.amplitude.getLevel()
                );
              },
            },
            {
      ...
      return (
        (function (t, e, n) {
        ...
        })(t, [
          {
            ...
            value: function (t, e, n) {
              ...
              this.output.gain.cancelScheduledValues(o),
                this.output.gain.linearRampToValueAtTime(u, s + 0.001),
          ...
          },
          {
            ...
            value: function () {
              return (
                "undefined" != typeof fade && (this._drywet.fade.value = fade),
          ...
          },
          {
            ...
            value: function () {
              ...
              p.soundArray.splice(t, 1),
                ...
                this.output && (this.output.disconnect(), delete this.output),
                this._drywet &&
                  (this._drywet.disconnect(), delete this._drywet),
    ...
    var It = (function () {
        function n(t) {
          ...
          return (
            Nt(this, n),
            ((e = jt(this, Vt(n).call(this))).biquad =
        ...
        return (
          ...
          (function (t, e, n) {
              ...
              value: function () {
                return (
                  ...
                  !0 === this._on
                    ...
                    : !1 === this._on && (this.biquad.type = "allpass"),
                  this._on
                );
              },
            },
            ...
            },
            {
              key: "dispose",
              value: function () {
                Mt(Vt(n.prototype), "dispose", this).call(this),
      ...
      Ut = (function () {
        function t() {
          return Nt(this, t), jt(this, Vt(t).call(this, "lowpass"));
        }
        return Ft(t, It), t;
      })(),
      Gt = (function () {
        function t() {
          return Nt(this, t), jt(this, Vt(t).call(this, "highpass"));
        }
        return Ft(t, It), t;
      })(),
      Lt = (function () {
        function t() {
          return Nt(this, t), jt(this, Vt(t).call(this, "bandpass"));
        }
        return Ft(t, It), t;
      })(),
      zt = It;
    ...
    var $t = (function () {
      function i(t, e) {
        ...
        return (
          ...
          (n = Xt(this, Yt(i).call(this, "peaking"))).disconnect(),
          n.set(t, e),
    ...
    var ie = (function () {
      function s(t) {
        ...
        !(function (t, e) {
          ...
          (e = Kt(this, ee(s).call(this))),
          (n = 3 === (t = 3 === t || 8 === t ? t : 3) ? Math.pow(2, 3) : 2),
          (e.bands = []);
        for (var o = 0; o < t; o++)
          (r =
            o === t - 1
      ...
      return (
        ...
        (function (t, e, n) {
          ...
          },
          {
            ...
            value: function () {
              if (
                (te(ee(s.prototype), "dispose", this).call(this), this.bands)
              ) {
              ...
              return (
                3 === arguments.length || 4 === arguments.length
                  ...
                  : (6 !== arguments.length && 7 !== arguments) ||
                    (this.orientForward(t, e, n), this.orientUp(i, r, o, s)),
                [
    ...
    var pe = (function () {
      function e() {
        ...
        return (
          ...
          ((t = ue(this, le(e).call(this))).panner = t.ac.createPanner()),
      ...
      return (
        ...
        (function (t, e, n) {
          ...
          },
          {
            key: "dispose",
            value: function () {
              ce(le(e.prototype), "dispose", this).call(this),
    ...
    var ge = (function () {
      function e() {
        ...
        return (
          ...
          ((t = ye(this, ve(e).call(this)))._split =
          ...
          (t._leftFilter = new zt()),
          (t._rightFilter = new zt()),
          t._leftFilter.disconnect(),
          t._rightFilter.disconnect(),
          t._leftFilter.biquad.frequency.setValueAtTime(1200, t.ac.currentTime),
          t._rightFilter.biquad.frequency.setValueAtTime(
            1200,
            t.ac.currentTime
          ),
          t._leftFilter.biquad.Q.setValueAtTime(0.3, t.ac.currentTime),
          t._rightFilter.biquad.Q.setValueAtTime(0.3, t.ac.currentTime),
          ...
          t._leftFilter.biquad.gain.setValueAtTime(1, t.ac.currentTime),
          t._rightFilter.biquad.gain.setValueAtTime(1, t.ac.currentTime),
          t.setType(0),
      ...
      return (
        ...
        (function (t, e, n) {
        ...
        })(e, [
          {
            ...
            value: function (t, e, n, i) {
              ...
              t.connect(this.input),
                ...
                i && (this._leftFilter.freq(i), this._rightFilter.freq(i));
            },
          },
          {
            key: "delayTime",
          ...
          },
          {
            key: "dispose",
            value: function () {
              me(ve(e.prototype), "dispose", this).call(this),
                this._split.disconnect(),
    ...
    var Ce = (function () {
        function e() {
          ...
          return (
            Te(this, e),
            (t = Se(this, Pe(e).call(this)))._initConvolverNode(),
              ...
              value: function () {
                ...
                for (e = 0; e < i; e++)
                  (t = this._reverse ? i - e : e),
                    (s[e] = (2 * Math.random() - 1) * Math.pow(1 - t / i, r)),
                    (a[e] = (2 * Math.random() - 1) * Math.pow(1 - t / i, r));
                this._setBuffer(o);
              },
            },
            {
              key: "dispose",
              value: function () {
                ke(Pe(e.prototype), "dispose", this).call(this),
                  this._teardownConvolverNode();
              },
            },
          ]),
      ...
      Re = (function () {
        function r(t, e, n) {
          ...
          return (
            Te(this, r),
            (i = Se(this, Pe(r).call(this)))._initConvolverNode(),
        ...
        return (
          ...
          xe(r, [
            ...
            },
            {
              key: "dispose",
              value: function () {
                for (var t in (ke(Pe(r.prototype), "dispose", this).call(this),
                this.impulses))
                  this.impulses[t] && (this.impulses[t] = null);
              },
            },
          ]),
          r
    ...
    var Be = (function () {
      function t() {
        !(function (t, e) {
          ...
          (this.clock = new Ee.a({ callback: this.ontick.bind(this) })),
          (this.syncedParts = []),
          (this.bpm = 120),
          this._init(),
          (this.prevTick = 0),
                ...
                this.syncedParts.forEach(function (t) {
                  t.isPlaying &&
                    ...
                    t.phrases.forEach(function (t) {
                      ...
                      0 !== e[n] &&
                        (r.metroTicks < e.length || !t.looping) &&
                        t.callback(i, e[n]);
                    }));
                }),
                  (this.metroTicks += 1),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              (this.tatumTime = i),
                ...
                this.clock.frequency.linearRampToValueAtTime(t, r + n),
                (this.bpm = t);
            },
          },
          {
    ...
    p5.prototype.setBPM = function (t, e) {
      for (var n in ((Fe = t), p.parts)) p.parts[n] && p.parts[n].setBPM(t, e);
    };
    function De(t, e, n) {
      Ve(this, De),
        (this.phraseStep = 0),
    ...
    var Ie = (function () {
        ...
        return (
          Me(n, [
            ...
            },
            {
              ...
              value: function (t, e, n) {
                var i;
                if (3 === arguments.length) i = new De(t, e, n);
                else {
                  if (!(t instanceof De))
            ...
            },
            {
              ...
              value: function (t, e) {
                for (var n in this.phrases)
                  this.phrases[n].name === t && (this.phrases[n].sequence = e);
              },
            },
            {
              key: "incrementStep",
      ...
      Ue = (function () {
        function n() {
          Ve(this, n), (this.parts = []), (this.currentPart = 0);
          var t = this;
        ...
        })(i, [
          {
            ...
            value: function (t) {
              var e = t || 0,
                n = p.audiocontext.currentTime;
              this.isPlaying ||
                (this.clock.start(n + e), (this.isPlaying = !0));
            },
          },
          {
            key: "stop",
          ...
          },
          {
            ...
            value: function (t) {
              var e = t || 0,
                n = p.audiocontext.currentTime;
              this.isPlaying &&
                (this.clock.pause(n + e), (this.isPlaying = !1));
            },
          },
          {
            key: "syncedStart",
    ...
    var Qe = (function () {
      function e() {
        ...
        return (
          ...
          ((t = Xe(this, He(e).call(this))).compressor =
      ...
      return (
        ...
        (function (t, e, n) {
            ...
            value: function (t, e) {
              ...
              return (
                "number" == typeof t
                  ...
                  : void 0 !== t && t.connect(this.compressor.attack),
            ...
            value: function (t, e) {
              ...
              return (
                "number" == typeof t
                  ...
                  : void 0 !== t && t.connect(this.compressor.knee),
            ...
            value: function (t, e) {
              ...
              return (
                "number" == typeof t
                  ...
                  : void 0 !== t && t.connect(this.compressor.ratio),
            ...
            value: function (t, e) {
              ...
              return (
                "number" == typeof t
                  ...
                  : void 0 !== t && t.connect(this.compressor.threshold),
          ...
          },
          {
            key: "dispose",
            value: function () {
              Ye(He(e.prototype), "dispose", this).call(this),
                this.compressor &&
        ...
        (function (t, e, n) {
        ...
        })(r, [
          {
            ...
            value: function (t) {
              ...
              e > this.cutoff && e > this.threshold && 0 < e - this.penergy
                ? (this._onPeak(),
                  (this.isDetected = !0),
      ...
      nn = (function () {
        function e() {
          !(function (t, e) {
            ...
            (this.input = en.createGain()),
            (this.output = en.createGain()),
            (this._inputChannels = 2),
            (this._outputChannels = 2);
          var t = y(1024);
          (this._workletNode = new AudioWorkletNode(en, s.a.recorderProcessor, {
    ...
    function ln(t) {
      for (
        ...
        (e = (2 * o) / 44100 - 1),
          (i[o] = ((3 + n) * e * 20 * r) / (Math.PI + n * Math.abs(e)));
      return i;
    }
    var hn = (function () {
      function r(t, e) {
      ...
      return (
        ...
        (function (t, e, n) {
          ...
          },
          {
            ...
            value: function (t, e) {
              if (t) {
                ...
                (this.amount = n), (this.waveShaperNode.curve = ln(n));
              }
          ...
          },
          {
            key: "dispose",
            value: function () {
              an(un(r.prototype), "dispose", this).call(this),
                this.waveShaperNode &&
        ...
        return (
          ...
          ((t = (function (t, e) {
            return !e || ("object" !== mn(e) && "function" != typeof e)
              ? _n(t)
              : e;
          })(this, bn(e).call(this))).oscillator = new rt()),
          (t.env = new at()),
          t.env.setRange(1, 0),
          t.env.setExp(!0),
          ...
          t.oscillator.start(),
          t.connect(),
          p.soundArray.push(_n(t)),
          Object.defineProperties(_n(t), {
            attack: {
              get: function () {
      ...
      return (
        ...
        (function (t, e, n) {
          ...
          },
          {
            key: "dispose",
            value: function () {
              gn(bn(e.prototype), "dispose", this).call(this),
      ...
      return (
        (function (t, e, n) {
        ...
        })(r, [
          {
            ...
            value: function (t, e) {
              if (
                ((this.energy = t.getEnergy(this.freqLow, this.freqHigh) / 255),
                !1 === this.isDetected &&
        ...
        (function (t, e, n) {
          ...
          },
          {
            ...
            value: function (t, e, n, i, r, o) {
              ...
              this.audiovoices[this.notes[t].getValueAtTime(a)].setADSR(
                e,
                n,
                i,
                r
          ...
          },
          {
            ...
            value: function (t, e, n) {
              ...
              this.notes[s] &&
                ...
                this._voicesInUse.getValueAtTime(o) < this.maxVoices
                  ? (i = Math.max(~~this._voicesInUse.getValueAtTime(o), 0))
                  : ((i = this._oldest),
                    (oldestNote = l(
            ...
            value: function (t, e) {
              ...
              if (t) {
                ...
                if (this.notes[o] && null !== this.notes[o].getValueAtTime(r)) {
                  var s = Math.max(
                    ~~this._voicesInUse.getValueAtTime(r).value,
                    1
                  );
                ...
                this.notes))
                  this.notes[a].dispose(), delete this.notes[a];
            },
          },
          {
            key: "connect",
      ...
      (p5.prototype.soundFormats = function () {
        ...
        for (var t = 0; t < arguments.length; t++) {
          if (
            ...
            !(-1 < ["mp3", "wav", "ogg", "m4a", "aac"].indexOf(arguments[t])))
          )
        ...
        if ("string" == typeof t) {
          ...
          if (-1 < ["mp3", "wav", "ogg", "m4a", "aac"].indexOf(n)) {
            if (!p5.prototype.isFileSupported(n))
              for (
                var i = e.split("."), r = i[i.length - 1], o = 0;
      ...
      (p5.prototype._mathChain = function (t, e, n, i, r) {
        for (var o in t.mathOps)
          t.mathOps[o] instanceof r &&
            (t.mathOps[o].dispose(),
            (n = o) < t.mathOps.length - 1 && (i = t.mathOps[o + 1]));
        return (
